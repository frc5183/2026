...
object FLSwerveModuleConstants : SwerveModuleConstants {
    ...
    override val ABSOLUTE_ENCODER: SwerveAbsoluteEncoder = CANCoderSwerve(10)
    override val ABSOLUTE_ENCODER_OFFSET: Angle = Units.Degrees.of(172.617)
    ...
    override val ANGLE_MOTOR: SwerveMotor = TalonFXSwerve(12, true, SwerveModulePhysicalConstants.MOTOR_TYPE)
